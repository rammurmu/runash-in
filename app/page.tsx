      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="container relative z-1 flex h-full flex-col items-center justify-center text-center text-white">
          ...
          <p className="mt-6 max-w-2xl text-lg sm:text-xl">
            A AI live streaming platform built specifically for automative sales
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
              Everything you need to create amazing digital experiences for your customers.
            </p>
          </div>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
                ...
                <p className="text-muted-foreground">
                  A short description of this amazing feature and how it benefits your users.
                </p>
              </div>
            ))}
          </div>
